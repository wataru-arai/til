# 学習ノート
## 2024/12/25
- 15章の練習問題終わり 本のサイトからリンクされていない問題もあるっぽいけど今は手がでなさそうなのでやめておく
- なんかちょくちょくExampleで書いてある結果が誤っている気がする 以下は誤っていそうな箇所のメモ
  - `Array Type Shenanigans > Step 1: Flat Filter`
    - `FilteredArrayItems<number[], string> -> number`とあるが、実際に書いてみると`never`になる
  - `Template Literal Type Shenanigans > Step 3: Split On`
    - `SplitOn<"hello my baby", " "> -> ["hello", "my", "baby"]`とあるが、実際に書いてみると`["baby", "my", "hello"]`になる
- 書いている本人でも間違うってことはまあ難しいってことなのかもしれない
- ひとまず本を読み切った形なので感想
  - なんというか原文がそうなんだろうけど、説明の文章が独特であんまり頭に入ってこない
    - あとちょいちょいジョークめいたものを差し込んでくるけど、言い回しに好みが分かれると思うし好きじゃないと理解の妨げになると思う
  - 練習問題も英語なのでわかりづらい ハマってたのが英文の読解力の問題だったりする
  - 通しで呼んで２ヶ月くらいかかったわけだが、時間かけすぎた感じある
    - 他の本を並行して読んでたのもあるけども
    - 練習問題とかある本は時間の上限を決めたほうがいい 5分くらいで手が動かなかったら答えみて写経したほうがいい
    - これくらいの本だったら1ヶ月くらいで読み切ってしまいたい気持ちがある
      - ダラダラやると気持ちが続かないので、できれば2週間~1ヶ月くらいでガッとやりたい
        - そうやるんだったら週末に2-3時間くらい時間をとって進めないとな
  - 英語を翻訳した文章は言い回し問題や（この本はいいけど）翻訳がしっくりこない場合があるので、勉強の優先度としては下げてもいいかもしれない
  - jsがそもそもわかってない問題があったのでここはちょっと勉強しないといけない
- 次に向けて
  - 1冊2週間~1ヶ月を目安に終わらせることを目標にする
  - 練習問題や写経に時間をかけすぎない 特に練習問題は5分で手が動かなかったら答えを見る
  - jsをまず勉強する or TSと並行して勉強する
    - サバイバルTypeScriptがいいかもしれない


## 2024/12/24
- 15章の練習問題 日付変わる前にコミットだけ
- 型演算難しい...再起する処理と組み合わせると疲れた頭では組み立てられない

## 2024/12/22
- 15章の途中まで読んだ 時間がないので少しだけ

## 2024/12/21
- 14章終わり
- enumという概念、ちょっと頭がバグりそうになる 値なのか型なのか（ランタイムの値が正しい）
